    ...
    <AdminTemplate :page="page" :modulo="modulo">
      <div slot="body">
        <div class="row">
          ...
          <div class="row mt-4">
            <!-- Tarjeta para total de nombre_d -->
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
              <div class="card">
                <div class="card-body p-3">
                  <div class="row">
                    <div class="col-8">
                      <div class="numbers">
                        <p class="text-sm mb-0 text-capitalize">
                          <strong>Total Gastado (Nombre D)</strong>
                        </p>
                        <h6 class="text-center text-lg font-weight-bolder text-black">
            ...
            <!-- Tarjeta para sucursales con contrato -->
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
              <div class="card">
                <div class="card-body p-3">
                  <div class="row">
            ...
            <!-- Tarjeta para sucursales sin contrato -->
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
              <div class="card">
                <div class="card-body p-3">
                  <div class="row">
...
export default {
  ...
  methods: {
    ...
    async fetchDashboardData() {
      try {
        const totalSolicitudesEstado1 = await this.GET_DATA('/Asolicitudes-estado-1');
        const totalSolicitudesEstado2 = await this.GET_DATA('/Asolicitudes-estado-2');
        const totalSolicitudesEstado3 = await this.GET_DATA('/Asolicitudes-estado-3');
        const totalSolicitudesEstado5 = await this.GET_DATA('/Asolicitudes-estado-5');
        const totalSolicitudesEstado1Hoy = await this.GET_DATA('/Asolicitudes-estado-1-hoy');
        const totalSolicitudesEstado2Hoy = await this.GET_DATA('/Asolicitudes-estado-2-hoy');
        const totalSolicitudesEstado3Hoy = await this.GET_DATA('/Asolicitudes-estado-3-hoy');
        const totalSolicitudesEstado5Hoy = await this.GET_DATA('/Asolicitudes-estado-5-hoy');
        const totalGastado = await this.GET_DATA('/Atotal-nombre-d');
        const totalSucursalesConContrato = await this.GET_DATA('/Asucursales-con-contrato');
        const totalSucursalesSinContrato = await this.GET_DATA('/Asucursales-sin-contrato');
