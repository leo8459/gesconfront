...
export default {
  ...
  data() {
    return {
      ...
      apiUrl: "encargados1",//nombre de la variable para jlar la api ruta
      page: "Usuarios",
      modulo: "AGBC",
      url_nuevo: "/admin/encargados/encargado/nuevo",
      url_editar: "/admin/encargados/encargado/editar/",//VA AL PRIMER ARCHIVO DE LA CARPETA
