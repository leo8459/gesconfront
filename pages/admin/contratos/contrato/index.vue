...
export default {
  ...
  data() {
    return {
      ...
      apiUrl: "contrato1",//nombre de la variable para jlar la administrador ruta
      page: "Usuarios",
      modulo: "AGBC",
      url_nuevo: "/admin/contratos/contrato/nuevo",
      url_editar: "/admin/contratos/contrato/editar/",//VA AL PRIMER ARCHIVO DE LA CARPETA
