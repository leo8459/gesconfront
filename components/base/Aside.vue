      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a
            ...
            href="#perfil-admin"
            class="nav-link"
            aria-controls="configuracion-admin"
            role="button"
            aria-expanded="false"
          >
            <div
          ...
          <div class="collapse" id="perfil-admin">
              ...
              <li class="nav-item">
                <nuxtLink class="nav-link" to="/admin/usuarios/usuario">
                 ...
                 <li class="nav-item">
                   <nuxtLink
                     class="nav-link"
                     to="/admin/solicitudes/solicitude"
                   >
                 ...
                 <li class="nav-item">
                   <nuxtLink
                     class="nav-link"
                     to="/admin/solicitudesemp/solicitudeemp"
                   >
                 ...
                 <li class="nav-item">
                   <nuxtLink
                     class="nav-link"
                     to="/admin/solicitudesj/solicitudej"
                   >
                 ...
                 <li class="nav-item">
                   ...
                   >
                     <span class="sidenav-mini-icon"> precios </span>
                     <span class="sidenav-normal"> precios </span>
                   </nuxtLink>
                 </li>
                 <li class="nav-item">
                   <nuxtLink
           ...
           <li class="nav-item">
          <a
            @click="handleItemClick('cajero')"
            data-bs-toggle="collapse"
            href="#perfil-cajero"
            class="nav-link"
            aria-controls="configuracion-cajero"
            role="button"
            aria-expanded="false"
          >
            <div
